...
void Drawing::String(int x, int y, char* string, D3DCOLOR color, ID3DXFont* font)
{
	RECT Position;
	Position.left = x;
	Position.top = y;
...
void Drawing::StringOutlined(int x, int y, char* String, D3DCOLOR color, D3DCOLOR outline, ID3DXFont* font)
{
	RECT FontPos;

	FontPos.left = x - 1;
	FontPos.top = y;
	font->DrawTextA(0, String, strlen(String), &FontPos, DT_NOCLIP, outline);
