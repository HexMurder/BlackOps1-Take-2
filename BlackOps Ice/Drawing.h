...
namespace Drawing
{
	void String(int x, int y, char* string, D3DCOLOR color, ID3DXFont* font);
	void StringOutlined(int x, int y, char* String, D3DCOLOR color, D3DCOLOR outline, ID3DXFont* font);
